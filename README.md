...
1. In 1-2 sentences, explain what React's `useRouteMatch` hook is used for.
     ...
     You would use this hook any time you are using a <Route> so it's able to get access to it's matched data. It matches the exact URL like <Route> would, basically instead of rendering a <Route>, just use useRouteMatch.
